...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var coop, password, user, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.cooperative.upsert({
                ...
                case 2:
                    ...
                    return [4 /*yield*/, bcrypt_1.default.hash('farmer123', 10)];
                case 3:
                    password = _a.sent();
                ...
                case 5:
                    error_1 = _a.sent();
                    console.error('❌ Error in simple seed:', error_1);
                    return [3 /*break*/, 8];
